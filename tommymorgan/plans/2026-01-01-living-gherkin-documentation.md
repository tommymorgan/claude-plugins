...
**Created**: 2026-01-01
**Goal**: Evolve plan-based Gherkin scenarios into living documentation that represents current system state, serving as foundation for user docs, developer docs, and test coverage analysis.
...
### Design Reference
See `/home/tommy/src/homelab/docs/plans/2026-01-01-living-gherkin-documentation-design.md` for complete design rationale and architecture.

### Implementation Strategy

**Phase 1: Migration Tool**
Build one-time migration script to bootstrap living specs from historical plans.

**Phase 2: Enhanced Plan Skill**
Modify plan skill to integrate interactive reconciliation with living specs.

**Phase 3: Enhanced Work Skill**
Modify work skill to automatically update living specs as scenarios complete.

**Phase 4: Documentation Generation**
Build tools for generating user docs, dev docs, and coverage reports.

### Key Design Decisions

**Why .feature files?**
Standard Gherkin format, tooling support, familiar to developers.

**Why @user and @technical tags?**
Separates audiences while keeping related scenarios together. Enables filtered doc generation.

**Why strict sequential?**
Ensures living specs stay synchronized. Simpler initial implementation. Can add parallelism later.

**Why smart inference for migration?**
Historical plans lack coordinated naming. Need to detect semantic similarity to avoid duplicates.

**Why interactive reconciliation?**
Prevents naming drift. Makes relationships between plans and living specs explicit. Reduces errors.

### Metadata Format

Future plans (after this one implements the system) will use:

```gherkin
# Living: apps/kizn/specs/authentication.feature::User logs in successfully
# Action: replaces
# Status: TODO
# Living updated: NO
...
This plan doesn't use that format since it's implementing the system itself.

### Action Types

- **creates**: Brand new scenario in living docs
- **replaces**: Completely overwrites existing scenario
- **extends**: Adds new Given/When/Then steps to existing scenario
- **removes**: Deletes scenario from living docs
- **deprecates**: Marks scenario obsolete with @deprecated tag

### Success Criteria

- Living .feature files created for all projects with historical plans
- Plan tool performs interactive reconciliation
- Work tool automatically updates living specs
- User docs generated from @user scenarios (no technical details)
- Developer docs generated from @technical scenarios
- Test coverage analysis identifies gaps
- Historical plans remain unchanged
- System documented in plugin README
